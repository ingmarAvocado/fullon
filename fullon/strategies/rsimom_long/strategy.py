...
class Strategy(strat.Strategy):
    ...
    def _set_signals(self):
        ...
        long_entry_cond = self.indicators_df['rsi'] > self.p.entry
        long_exit_cond = self.indicators_df['rsi'] < self.p.long_exit
    ...
    def risk_management(self):
        ...
        res = self.check_exit()
        if not res:
            if self.pos[0] > 0 and self.indicators.long_exit:
